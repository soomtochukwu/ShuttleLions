...
import { Vote, BarChart3, CheckCircle2, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-8 max-w-4xl mx-auto py-6">
      ...
      <div className="shuttle-panel p-6 sm:p-10 bg-sl-panel border border-sl-border space-y-6 text-center flex flex-col items-center">
        ...
        <div className="space-y-2">
          ...
          >
            Community Votes & Governance Polls
          </h1>
          <p className="text-xs sm:text-sm text-sl-muted font-medium max-w-lg mx-auto leading-relaxed">
            Democratic varsity decision-making, tournament format votes, and equipment preference surveys are currently in preparation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full pt-4 text-left">
          <div className="p-4 rounded-xl bg-sl-bg border border-sl-border space-y-1.5">
            <span className="text-xs font-black text-sl-foreground uppercase flex items-center gap-1.5">
              <BarChart3 className="w-3.5 h-3.5 text-sl-green" /> Live Tallying
            </span>
            <p className="text-[11px] text-sl-muted font-medium">
              Transparent, real-time vote aggregation across verified athletes.
            </p>
          </div>

          <div className="p-4 rounded-xl bg-sl-bg border border-sl-border space-y-1.5">
            <span className="text-xs font-black text-sl-foreground uppercase flex items-center gap-1.5">
              <ShieldCheck className="w-3.5 h-3.5 text-sl-green" /> 1-Member 1-Vote
            </span>
            <p className="text-[11px] text-sl-muted font-medium">
              Cryptographically verified poll tokens preventing vote duplicates.
            </p>
          </div>

          <div className="p-4 rounded-xl bg-sl-bg border border-sl-border space-y-1.5">
            <span className="text-xs font-black text-sl-foreground uppercase flex items-center gap-1.5">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" /> Tournament Rules
            </span>
            <p className="text-[11px] text-sl-muted font-medium">
              Vote on rally scoring formats, seeding brackets, and prize structures.
            </p>
          </div>
        </div>
